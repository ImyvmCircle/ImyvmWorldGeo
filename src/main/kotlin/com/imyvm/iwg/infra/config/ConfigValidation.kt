...
private val positiveOptions by lazy { listOf(
    ...
    CoreConfig.BEHAVIOR_STATS_SAVE_INTERVAL_MILLIS,
    CoreConfig.BEHAVIOR_STATS_FAILED_SAVE_RETRY_MILLIS,
    CoreConfig.BEHAVIOR_STATS_SHORT_PERIOD_RETENTION_MONTHS,
    CoreConfig.BEHAVIOR_STATS_MONTH_RETENTION_YEARS,
